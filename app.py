...
# --- SISTEMA DE SEGURIDAD Y PRIVACIDAD (LOPD) ---
...
if not st.session_state.autenticado:
    ...
    st.info("Por favor, identifícate como profesional autorizada para acceder a los datos médicos y de seguimiento.")
...
if st.session_state.logo_path and os.path.exists(st.session_state.logo_path):
    ...
    archivo_subido = st.sidebar.file_uploader("Sube el logo", type=["png", "jpg", "jpeg"])
